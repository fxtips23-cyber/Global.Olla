  ...
  return (
    <div className="w-full rounded-2xl overflow-hidden" style={{ background: "#050D18", aspectRatio: "16/9", maxHeight: 380 }}>
      <svg viewBox="0 0 900 506" className="w-full h-full" aria-hidden="true">
        ...
        <circle cx={69} cy={131} r={4} fill="#29B5D4" fillOpacity="0.6" />
        ...
        <path d="M38,210 C55,202 72,195 90,185 C108,175 122,178 138,168 C154,158 164,152 182,144 C190,140 196,142 205,138"
          stroke="#29B5D4" strokeWidth="1.5" fill="none" strokeOpacity="0.65" strokeLinecap="round" />
        {[0,1,2,3,4,5,6,7,8].map(i => {
          ...
          return (
            <rect key={i} x={x} y={215 - h} width={10} height={h}
              fill={bull ? "#29B5D4" : "#EF4444"} fillOpacity="0.5" rx="1" />
          );
        })}

        {/* Order ticket */}
        <rect x={40} y={248} width={155} height={75} fill="rgba(41,181,212,0.06)"
          stroke="rgba(41,181,212,0.2)" strokeWidth="1" rx="5" />
        ...
        {/* Buy button */}
        <rect x={40} y={333} width={72} height={18} fill="#29B5D4" fillOpacity="0.85" rx="3" />
        ...
        {/* Volume bar bottom */}
        <rect x={40} y={360} width={72} height={12} fill="rgba(41,181,212,0.2)" rx="2" />
        ...
        <path d="M205,253 L310,253" stroke="#29B5D4" strokeWidth="2" strokeOpacity="0.6"
          markerEnd="url(#arrow)" fill="none" />
        {/* Data packets */}
        {[0,1,2].map(i => (
          <circle key={i} cx={220 + i * 30} cy={253} r={3.5}
            fill="#29B5D4" fillOpacity={0.3 + i * 0.2} />
        ))}
        <text x={258} y={244} fill="#29B5D4" fontSize="7" fontFamily="monospace" textAnchor="middle" fillOpacity="0.6">ORDER</text>
        <text x={258} y={268} fill="white" fillOpacity="0.18" fontSize="6" fontFamily="monospace" textAnchor="middle">&lt;10ms</text>

        <defs>
          <marker id="arrow" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L6,3 Z" fill="#29B5D4" fillOpacity="0.7" />
          </marker>
        ...
        <rect x={310} y={80} width={280} height={346} fill="#081828" stroke="rgba(41,181,212,0.15)" strokeWidth="1.5" rx="8" />
        {/* Header */}
        <rect x={310} y={80} width={280} height={30} fill="rgba(41,181,212,0.08)" rx="8" />
        <rect x={310} y={98} width={280} height={12} fill="rgba(41,181,212,0.08)" />
        <text x={450} y={100} fill="#29B5D4" fontSize="9" fontFamily="monospace"
          fontWeight="bold" textAnchor="middle" fillOpacity="0.8">Olla Trade INFRASTRUCTURE</text>

        {/* Execution engine box */}
        <rect x={330} y={124} width={240} height={60} fill="rgba(41,181,212,0.06)"
          stroke="rgba(41,181,212,0.2)" strokeWidth="1" rx="5" />
        <text x={450} y={142} fill="#29B5D4" fontSize="8" fontFamily="monospace" textAnchor="middle" fillOpacity="0.7" letterSpacing="0.5">EXECUTION ENGINE</text>
        ...
        {[
          ...
          <g key={price}>
            <rect x={340} y={331 + i * 14} width={w} height={11} fill="rgba(41,181,212,0.1)" rx="1" />
            <text x={345} y={341 + i * 14} fill="white" fillOpacity="0.5" fontSize="7" fontFamily="monospace">{price}</text>
            <text x={462} y={341 + i * 14} fill="#29B5D4" fontSize="7" fontFamily="monospace" fillOpacity="0.7">{size}</text>
          </g>
        ))}
        ...
        <rect x={682} y={393} width={176} height={24} fill="rgba(41,181,212,0.08)"
          stroke="rgba(41,181,212,0.18)" strokeWidth="1" rx="5" />
        <text x={770} y={409} fill="#29B5D4" fontSize="8" fontFamily="monospace"
