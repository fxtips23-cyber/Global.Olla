    ...
    <section className="py-20 lg:py-28 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left: Rules */}
          <div>
            <div className="inline-flex items-center gap-2 bg-[#29B5D4]/10 text-[#29B5D4] text-xs font-semibold px-4 py-2 rounded-full mb-5 uppercase tracking-wider border border-[#29B5D4]/20">
              Promotion Rules
            </div>
            ...
            <ul className="space-y-3">
              {rules.map((rule, i) => (
                <li key={i} className="flex items-start gap-4 bg-white border border-gray-100 rounded-xl p-4 hover:border-[#29B5D4]/30 transition-colors">
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-[#29B5D4] text-[#29B5D4] hover:bg-[#29B5D4] hover:text-white font-semibold px-6 py-3 rounded-xl text-sm transition-all duration-200"
              >
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-sm">
              <div className="absolute inset-0 bg-[#29B5D4]/20 rounded-2xl translate-x-3 translate-y-3 blur-sm" />
              <div className="relative bg-[#07111F] rounded-2xl p-8 border border-white/10 shadow-2xl text-white">
                <div className="text-center mb-7">
                  <div className="text-5xl font-extrabold text-[#29B5D4] mb-1">20%</div>
                ...
                <div className="space-y-3 mb-7">
                  {[
                    ...
                    <div key={row.label} className="flex justify-between items-center py-2.5 border-b border-white/10">
                      ...
                      <span className="text-[#29B5D4] font-bold text-sm">{row.value}</span>
                    </div>
                  ))}
                </div>
                ...
                <Link
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#29B5D4] hover:bg-[#1FA5C4] text-white font-bold py-3.5 rounded-xl text-sm transition-colors"
                >
