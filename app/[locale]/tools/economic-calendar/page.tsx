    ...
    <>
      ...
      <section className="py-14 bg-[#050C15]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-[11px] font-semibold text-[#29B5D4] uppercase tracking-widest mb-4 text-center">{t("live_label")}</div>
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-6">
            <Link href="https://www.mql5.com/en/economic-calendar" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[12px] font-semibold text-[#29B5D4] hover:text-[#1FA5C4] transition-colors border border-[#29B5D4]/25 hover:border-[#29B5D4]/50 px-5 py-2.5 rounded-xl">
      ...
      <section className="py-16 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <div className="text-[11px] font-semibold text-[#29B5D4] uppercase tracking-widest mb-4">{t("how_label")}</div>
            ...
            <div>
              <div className="text-[11px] font-semibold text-[#29B5D4] uppercase tracking-widest mb-4">{t("tips_label")}</div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="text-[11px] font-semibold text-[#29B5D4] uppercase tracking-widest mb-4">{t("impact_label")}</div>
      ...
      <section className="py-16 bg-[#050C15]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="text-[11px] font-semibold text-[#29B5D4] uppercase tracking-widest mb-4">{t("events_label")}</div>
              ...
              return (
                <div key={name} className="bg-white/4 border border-white/8 rounded-2xl p-5 hover:bg-white/6 transition-all flex flex-col">
                  ...
                  <div className="flex flex-col gap-0.5 mb-3">
                    <span className="text-[10px] text-[#29B5D4] font-semibold">{currency}</span>
                  ...
                  <div className="bg-white/4 border border-white/6 rounded-lg p-2.5 mt-auto">
                    <div className="text-[9px] font-bold text-[#29B5D4] uppercase tracking-wider mb-1">{locale === "pt" ? "Dica" : "Trader Tip"}</div>
