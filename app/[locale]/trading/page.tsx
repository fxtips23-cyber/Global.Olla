            ...
            {links.map(({ title, sub, href }, i) => {
              ...
              return (
                <Link key={href} href={href}
                  className="group bg-white border border-gray-100 rounded-2xl p-6 hover:border-[#29B5D4]/25 hover:shadow-lg hover:-translate-y-1 transition-all">
                  ...
                  <h3 className="text-[14px] font-bold text-[#111827] mb-1 group-hover:text-[#29B5D4] transition-colors">{title}</h3>
