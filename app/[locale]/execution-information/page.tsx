...
export default async function ExecutionInformationPage({ params }: { params: Promise<{ locale: string }> }) {
 ...
 <h2 className="text-3xl sm:text-4xl font-extrabold text-[#111827] mb-5 leading-tight">
 ...
 <h2 className="text-3xl font-extrabold text-[#111827] mb-3">Order Execution Explained</h2>
 ...
 <h2 className="text-3xl font-extrabold text-[#111827] mb-3">Trading Infrastructure</h2>
 <p className="text-gray-500 max-w-2xl mx-auto text-[15px]">
 ...
 <div className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-6 text-center">Order Flow</div>
 ...
 "arrow" in item ? (
 <span key={i} className="text-gray-300 text-xl hidden sm:block">→</span>
 ) : (
 <div key={i} className="flex flex-col items-center text-center px-4 py-3 bg-white border border-gray-100 rounded-xl min-w-[110px]">
 <div className="text-[12px] font-bold text-[#111827]">{item.label}</div>
 ...
 <h2 className="text-3xl font-extrabold text-[#111827] mb-3">Understanding Slippage</h2>
 <p className="text-gray-500 max-w-2xl mx-auto text-[15px]">
 ...
 <h3 className="text-lg font-bold text-[#111827]">Positive Slippage</h3>
 </div>
 <p className="text-[13px] text-gray-500 leading-relaxed mb-4">
 Positive slippage occurs when an order is filled at a <strong className="text-[#111827]">better price</strong> than requested. For example, if you place a buy order at 1.08500 but the order executes at 1.08490, you received a more favourable entry. This benefits the client.
 </p>
 <div className="bg-[#00CC44]/8 border border-[#00CC44]/15 rounded-xl px-4 py-3">
 <div className="text-[12px] text-[#00AA38] font-semibold">Example: Better fill than requested</div>
 <div className="text-[11px] text-gray-500 mt-0.5">Requested: Buy at 1.08500 → Filled at 1.08490</div>
 </div>
 </div>
 {/* Negative */}
 <div className="bg-[#F5F7FA] border border-gray-100 rounded-2xl p-7">
 ...
 <h3 className="text-lg font-bold text-[#111827]">Negative Slippage</h3>
 </div>
 <p className="text-[13px] text-gray-500 leading-relaxed mb-4">
 Negative slippage occurs when an order is filled at a <strong className="text-[#111827]">worse price</strong> than requested. This is more common during rapid price movement or reduced liquidity. Olla Trade executes at the best available price but cannot guarantee the requested price under all conditions.
 </p>
 <div className="bg-red-50 border border-red-200 rounded-xl px-4 py-3">
 <div className="text-[12px] text-red-700 font-semibold">Example: Worse fill due to market movement</div>
 <div className="text-[11px] text-gray-500 mt-0.5">Requested: Buy at 1.08500 → Filled at 1.08520</div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-[#F5F7FA] border border-gray-100 rounded-2xl p-7">
 <h3 className="text-base font-bold text-[#111827] mb-5">When Slippage Is More Likely</h3>
 ...
 <div className="w-8 h-8 rounded-lg border border-gray-200 bg-[#F5F7FA] text-gray-500 flex items-center justify-center mb-3">
 <Icon className="w-4 h-4" />
 </div>
 <div className="text-[13px] font-bold text-[#111827] mb-1">{title}</div>
 <div className="text-[12px] text-gray-500 leading-relaxed">{desc}</div>
 ...
 <h2 className="text-3xl font-extrabold text-[#111827] mb-3">Available Order Types</h2>
 <p className="text-gray-500 max-w-2xl mx-auto text-[15px]">
 ...
 { Icon: IconTarget, name: "Buy/Sell Limit", desc: "Pending order to open at a more favourable price than current market. A Buy Limit opens below current price; a Sell Limit opens above.", tag: "Better Price", tc: "bg-blue-50 text-blue-700 border-blue-200" },
 { Icon: IconActivity,name:"Buy/Sell Stop", desc: "Pending order to open beyond the current market level. A Buy Stop triggers above current price; a Sell Stop triggers below.", tag: "Breakout", tc: "bg-purple-50 text-purple-700 border-purple-200" },
 { Icon: IconLock, name: "Stop Loss", desc: "Automatically closes a losing position when the market reaches a specified level. Helps manage downside risk. Execution is not guaranteed at the exact price during rapid price movements.", tag: "Risk Management",tc: "bg-amber-50 text-amber-700 border-amber-200" },
