      ...
      <section className="py-8 bg-[#F5F7FA]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="border border-blue-200 bg-blue-50 rounded-xl p-5 text-center">
            <p className="text-[13px] text-blue-800">This Privacy Policy was last reviewed in 2025. We will notify clients of any material changes by updating this page.</p>
          </div>
        </div>
      </section>
