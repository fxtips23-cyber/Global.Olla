              ...
              {[
                ...
                <div key={id} id={id}>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-xl border border-gray-200 dark:border-[#1F2937] bg-[#F5F7FA] dark:bg-[#0A1220] text-gray-500 dark:text-[#6B7280] flex items-center justify-center flex-shrink-0"><Icon className="w-4 h-4" /></div>
                    <h2 className="text-xl font-extrabold text-[#111827] dark:text-[#F9FAFB]">{title}</h2>
                  </div>
                  <div className="text-[14px] text-gray-600 dark:text-[#9CA3AF] leading-relaxed">{body}</div>
                </div>
              ))}
            </div>
          </div>
